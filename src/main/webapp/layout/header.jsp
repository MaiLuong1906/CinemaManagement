                ...
                <c:choose>
                    ...
                    <c:when test="${sessionScope.user == null}">
                        <a href="${pageContext.request.contextPath}/views/auth/login.jsp" 
                           class="btn btn-sm btn-outline-light btn-login-custom rounded-pill px-3 py-2 fw-semibold">
                            <i class="fas fa-sign-in-alt me-1"></i> Login
                        </a>
                        <a href="${pageContext.request.contextPath}/views/auth/register.jsp" 
                           class="btn btn-sm btn-signup-custom rounded-pill px-3 py-2 fw-semibold border-0">
                    ...
                    <c:when test="${sessionScope.user != null && sessionScope.user.roleId == 'User'}">
                        <div class="user-badge d-flex align-items-center gap-2 px-3 py-2 rounded-pill me-2">
                            <div class="d-flex align-items-center justify-content-center rounded-circle avatar-circle">
                        ...
                        <a href="${pageContext.request.contextPath}/AccountServlet?action=logout" 
                           class="btn btn-sm btn-outline-danger btn-logout-custom rounded-pill px-3 py-2 fw-semibold">
                    ...
                    <c:when test="${sessionScope.user != null && sessionScope.user.roleId == 'Admin'}">
                        <div class="admin-badge d-flex align-items-center gap-2 px-3 py-2 rounded-pill me-2">
                            <div class="d-flex align-items-center justify-content-center rounded-circle avatar-circle">
