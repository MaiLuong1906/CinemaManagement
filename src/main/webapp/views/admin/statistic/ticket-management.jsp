<%-- Document : ticket-management Created on : Jan 31, 2026, 2:49:45 AM Author : nguye --%>
    ...
    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
            <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
                ...
                <body>
                    <!-- Back -->
                    <a href="${pageContext.request.contextPath}/admin/statistic" class="btn-back">
                        Back
                    </a>
                    <h1>Thống kê vé</h1>
                                        ...
                                        <c:forEach items="${ticketSoldBySlot}" var="s">
                                            <tr>
                                                ...
                                                <td class="fw-bold text-gradient">
                                                    <fmt:formatNumber value="${s.slotRevenue}" type="number"
                                                        groupingUsed="true" /> ₫
                                                </td>
                                            </tr>
                                        </c:forEach>
                    ...
                    <script>
                        function nextPage() {
                            ...
                            if (current < total) {
                                window.location.href = "?action=tickets&page=" + (current + 1);
                            }
                        }
