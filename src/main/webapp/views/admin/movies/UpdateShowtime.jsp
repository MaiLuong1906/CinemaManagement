<%-- Document : UpdateShowtime Created on : Jan 25, 2026, 3:11:51 AM Author : nguye --%>
        ...
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            ...
            <body class="bg-light">
                ...
                <div class="container mt-4">
                    ...
                    <form action="${pageContext.request.contextPath}/showtime?action=update" method="post"
                        ...
                        <div class="mb-3">
                            ...
                            <select name="hallId" class="form-select" required>
                                <c:forEach var="h" items="${hallList}">
                                    <option value="${h.hallId}" ${h.hallId==showtime.hallId ? "selected" : "" }>
                                        ${h.hallName}
                                    </option>
                                </c:forEach>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="showDate" value="${showtime.showDate}" class="form-control"
                                required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="slotId" class="form-select" required>
                                <c:forEach var="s" items="${slotList}">
                                    <option value="${s.slotId}" ${s.slotId==showtime.slotId ? "selected" : "" }>
