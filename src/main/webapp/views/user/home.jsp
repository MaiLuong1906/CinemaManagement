                ...
                <div class="slider-container" id="sliderContainer">
                    <c:if test="${not empty topRatedMovies}">
                        <c:forEach var="movie" items="${topRatedMovies}">
                            <div class="slide"
                                style="background-image: url('${pageContext.request.contextPath}/image?name=${movie.posterUrl}');"
                                ...
                                <div class="slide-content">
                                    ...
                                    <p class="fs-5 mb-4"
                                        style="line-height: 1.6; text-shadow: 1px 1px 2px rgba(0,0,0,0.5);">
                                        ${movie.description}
                                    </p>
                                    <div class="d-flex gap-3">
                                        <a href="#"
                                            class="btn btn-gradient-primary btn-lg rounded-3 px-4 text-white fw-bold">
