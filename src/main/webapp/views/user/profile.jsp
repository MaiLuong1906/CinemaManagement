                                ...
                                <form action="${pageContext.request.contextPath}/update-profile">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="tel" class="form-control rounded-3" name="phoneNumber"
                                                   value="${user.phoneNumber}" required readonly>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-semibold">Ngày sinh</label>
                                            <input type="date" class="form-control rounded-3" name="dob"
                                                   value="${user.dateOfBirth}">
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label fw-medium d-block">Giới tính</label>
                                            <div class="d-flex gap-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="gender"
                                                           id="male" value="male" <c:if
                                                               test="${user.gender == 'true'}">checked</c:if>>
                                                           <label class="form-check-label" for="male">Nam</label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="gender"
                                                               id="female" value="female" <c:if
                                                            test="${user.gender == 'false'}">checked</c:if>>
                            ...
                            <div class="glass rounded-4 p-4 p-lg-5">
                                ...
                                <div class="d-flex flex-column gap-3">
                                    ...
                                    <div class="glass rounded-3 p-4 border-start border-primary border-4">
                                        <div class="row align-items-center g-3">
                                            <div class="col-md-2">
                                                <img src="https://via.placeholder.com/120x180/764ba2/ffffff?text=Movie"
                                                     class="img-fluid rounded-2 w-100" alt="Movie">
                                            </div>
                                            <div class="col-md-7">
                                                <h5 class="fw-bold mb-2">Top Gun: Maverick</h5>
                                                <div class="text-secondary small mb-1">
                                                    <i class="fas fa-calendar me-1"></i>20/01/2026 - 21:30
                                                </div>
                                                <div class="text-secondary small mb-1">
                                                    <i class="fas fa-map-marker-alt me-1"></i>Lotte Cinema Diamond
                                                    Plaza
                                                </div>
                                                <div class="text-secondary small">
                                                    <i class="fas fa-couch me-1"></i>Ghế: B5, B6
                                                </div>
                                            </div>
                                            <div class="col-md-3 text-md-end">
                                                <span
                                                ...
                                                <div class="h5 fw-bold text-primary mb-2">180.000 đ</div>
                                                <button class="btn btn-sm btn-outline-light rounded-pill px-3">
                                                    <i class="fas fa-qrcode me-1"></i>Xem vé
                                                </button>
                                            </div>
                                    ...
                                    <!-- Ticket 3 - Pending -->
                                    <div class="glass rounded-3 p-4 border-start border-warning border-4">
                                        <div class="row align-items-center g-3">
                                            <div class="col-md-2">
                                                <img src="https://via.placeholder.com/120x180/e74c3c/ffffff?text=Movie"
                                                     class="img-fluid rounded-2 w-100" alt="Movie">
                                            </div>
                                            <div class="col-md-7">
                                                <h5 class="fw-bold mb-2">Spider-Man: No Way Home</h5>
                                                <div class="text-secondary small mb-1">
                                                    <i class="fas fa-calendar me-1"></i>28/01/2026 - 15:00
                                                </div>
                                                <div class="text-secondary small mb-1">
                                                    <i class="fas fa-map-marker-alt me-1"></i>Galaxy Nguyễn Du
                                                </div>
                                                <div class="text-secondary small">
                                                    <i class="fas fa-couch me-1"></i>Ghế: C3, C4, C5
                                                </div>
                                            </div>
                                            <div class="col-md-3 text-md-end">
                                                <span
                                                ...
                                                <div class="h5 fw-bold text-primary mb-2">270.000 đ</div>
                                                <button
                                                    class="btn btn-sm btn-gradient text-white rounded-pill px-3">
