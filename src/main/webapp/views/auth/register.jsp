<%@page contentType="text/html" pageEncoding="UTF-8" %>
    ...
    <body>
        ...
        <% String fullname=request.getAttribute("fullname") !=null ? request.getAttribute("fullname").toString() : "" ;
            ...
            String dobStr=request.getAttribute("dob") !=null ? request.getAttribute("dob").toString() : "" ; String
            gender=request.getAttribute("gender") !=null ? request.getAttribute("gender").toString() : "" ; String
            address=request.getAttribute("address") !=null ? request.getAttribute("address").toString() : "" ; %>
                        ...
                        <% if (request.getAttribute("Error") !=null &&
                            ...
                            <% }%>
                                ...
                                <form action="${pageContext.request.contextPath}/AccountServlet" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <button type="button"
                                                ...
                                                style="z-index: 10; text-decoration: none; padding: 0.5rem; opacity: 0.5; color: #6c757d;"
                                                onmouseover="this.style.opacity='0.8'"
                                                onmouseout="this.style.opacity='0.5'"
                                                onclick="togglePasswordRegister('password', this)">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <button type="button"
                                                ...
                                                onmouseover="this.style.opacity='0.8'"
                                                onmouseout="this.style.opacity='0.5'"
                                                onclick="togglePasswordRegister('cpassword', this)">
                                                <i class="fas fa-eye" style="font-size: 1rem;"></i>
                                            </button>
                                        </div>
                                    ...
                                    <div
                                        class="form-check d-flex justify-content-center align-items-center gap-2 my-4 terms-check">
            ...
            <script>
                function togglePasswordRegister(inputId, button) {
